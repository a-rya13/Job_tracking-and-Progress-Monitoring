       ...
       <header className={styles.header}>
        ...
        <div className={styles.ctn8}>
            ...
            <div className={styles.sec6}>
              ...
              <p className={styles.caption9}>  <img src={icon4} className={styles.icon4} />Arya Agarwal </p>
              <p className={styles.caption9}>  <img src={icon5} className={styles.icon5} />arya@gmail.com </p>
            </div>
